...
df = conn.query("SELECT fx_date, usd, last_60_max, last_60_min, \
    last_30_avg, last_180_avg, last_360_avg FROM \
    fx.last_trend_nzd where 15 > DATE_PART('year', NOW()) - DATE_PART('year', fx_date) order by fx_date;", ttl="10m")
